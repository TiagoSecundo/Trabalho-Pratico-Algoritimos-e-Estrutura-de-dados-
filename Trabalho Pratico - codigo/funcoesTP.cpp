...
void menu() // Menu inical do programa
{
    ...
    cout << "6 Imprime contracheque. " << endl;
    cout << "7. Sair. " << endl;
}
...
void InsereListaUltimo(TListaEncadeada *lista, TFuncionario *item) // Incrementa dados na ultima posiçãpo validando-a na lista
{
...
void IncludeProjetos(TListaEncadeada *projetos) // Feita para armazenar projetos na lista encadeada.
{
    TApontador aux;
    TProjeto b;
    TChave id;
